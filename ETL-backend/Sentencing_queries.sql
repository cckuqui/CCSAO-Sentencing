...
SELECT 
    participants.age_at_incident, 
    participants.gender, 
    participants.race, 
    participants.age_bins, 
    courts.court_name, 
    offenses.offense_category, 
...
SELECT 
    sentences.committment_term, 
    sentences.commitment_unit, 
    sentences.sentence_type, 
    offenses.offense_category, 
    courts.court_name
FROM results
