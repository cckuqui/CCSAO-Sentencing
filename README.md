...
This particular project has been coded with both Python and JavaScript, with the majority of work being coded collaboratively over Zoom. There is a initiative by [Hacking 4 Justice](https://hacking4justice.org/) to train the public to evaluate these datasets using R.  An example of one such project on **narcotics vs. non-narcotics cases** from the Dispositions dataset was analyzed by [Nick Jones](https://github.com/nrjones8?tab=repositories) for cases from 2011-2016.  His [website](https://nrjones8.me/cook-county-sao-dispositions.html) provides an overview of that project using the CCSAO datasets, with some background on his [data cleaning methodology](https://nrjones8.me/dplyr-intro-sao-data.html). His code can be found [here](https://github.com/nrjones8/cook-county-states-attorney).
